...
sudo pacman -S --noconfirm --needed nvidia xorg xorg-xinit xorg-xsetroot nitrogen spotifyd ranger github-cli picom xautolock cronie git  anki p7zip xbindkeys htop python-pip feh dbeaver vlc scrot unclutter bluez-tools bluez-utils make base-devel unzip remmina xclip ttf-nerd-fonts-symbols-mono gvim brightnessctl alsa-utils pavucontrol lxappearance arc-gtk-theme
