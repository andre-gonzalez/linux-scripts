...
DEFAULT_TTL=28800           # Cache duration for items list (seconds)
DEFAULT_CLEAR_AFTER=30   # Clipboard auto-clear delay (seconds)
...
notify-send "Bitwarden" "Username and password copied to clipboard (clears in ${CLEAR_AFTER}s)"
