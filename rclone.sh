...
declare -a dirs=(
  "/mnt/hd-interno/backup-arch-samsung/s3/"
)
...
# Only working manually the one working is the command below:
# rclone sync /mnt/hd-interno/backup-arch-samsung/s3/ personal:backups-pessoal --skip-links --progress --bwlimit 100M
